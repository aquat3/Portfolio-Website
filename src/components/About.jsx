    ...
    return(
      <div className='aboutRight'>
        ...
        <ScrollAnimation animateOnce={true} animateIn='slideInRight' duration={0.3}>
          ...
          <ScrollAnimation animateOnce={true} animateIn='slideInRight' duration={0.3}><p>I have been programming since I was 17 with C++, but I eventually picked up web development 
             after being curious as to how websites work and
             I grew a passion for it. After discovering my passion for coding, I realized this is what I wanted 
